...
<div class="container">
    ...
    color: white;" href="Contak.php"> Get in touch </a>
        </div>
    </div>
...
<div class="telo-obrazka">
    ...
    <img src="obrazky/children-close-up-crowd-764681-1.jpg" alt="jpg">
</div>
...
<div class="divko-modre">
    <div class="medzi">
    <img src="obrazky/icon-implementation-support-1.png" alt="">
    </div>
    ...
    <p>The classroom environment at Stratford allows your childs’ educators to give them the time and attention that they need in order to succeed. We believe in keeping class numbers low to maximum learning potential.</p>
        ...
        <div class="divko-modre">
            <div class="medzi">
                <img src="obrazky/icon-managed-hosting-1.png" alt="">
            </div>
            <div style="padding-left: 5em">
        ...
        <div class="divko-modre">
            <div class="medzi">
                <img src="obrazky/icon-build-digital-experiences-1.png" alt="">
            </div>
            <div style="padding-left: 5em">
...
<div class="telo-modra" style="padding-left: 5%; padding-right: 5%;">
    ...
    color: #3e69dc;" href="Contak.php">BOOK AN ASSESSMENT</a>
        </div>
    </div>
</div>
